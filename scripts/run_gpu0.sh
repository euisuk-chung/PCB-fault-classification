#!/bin/bash
# plain_efficientnetb5 >> train_ovr
python main.py\
...
# plain_efficientnetb7 >> train_ovr
python main.py\
        --base_dir="/repo/course/sem21_01/PCB-fault-classification/"\
        --label_dir="/repo/course/sem21_01/PCB-fault-classification/label.csv" \
        --ckpt_path="/repo/course/sem21_01/PCB-fault-classification/ckpt/"\
        --mode="train_ovr"\
        --lr_type='multi'\
        --base_model='plain_efficientnetb7'\
        --model_index=88\
        --verbose=20 \
        --epochs=50 \
        --device_index=0\
...
## model_index = 150 >>> mode="train_ovr", lr_type='multi', epochs=50, base_model=plain_resnet18, --batch_size=16
...
## model_index = 1500 >>> mode="train_ovr", lr_type='multi', epochs=50, base_model=pretrained_resnet18, --batch_size=16
...
## model_index = 66 >>> mode="train_ovr", lr_type='multi', epochs=50, base_model=plain_efficientnetb4, --batch_size=8 (default)

## model_index = 7 >>> >>> mode="train", lr_type='multi', epochs=50, base_model=plain_efficientnetb5, --batch_size=2
## model_index = 77 >>> >>> mode="train", lr_type='multi', epochs=50, base_model=plain_efficientnetb5, --batch_size=2

## model_index = 8 >>> >>> mode="train", lr_type='multi', epochs=50, base_model=plain_efficientnetb7, --batch_size=2
## model_index = 88 >>> >>> mode="train", lr_type='multi', epochs=50, base_model=plain_efficientnetb7, --batch_size=2
